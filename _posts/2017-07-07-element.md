...
First, let's take a look at that intro. The first chord clues us into the fact that we're in the A minor scale, also known as the A natural minor scale. The notes in this scale are:
