...
Though Tartaglia was poor and self taught (reportedly he only learned half the alphabet from a private tutor before funds ran out), he was one of the most important thinkers of his era. He was the first to translate Euclid's _Elements_ into a modern European language, fixing a number of errors in the existing translations. Later on, Galileo (also an Italian) made extensive use of this translation.
